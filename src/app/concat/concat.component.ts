...
import { Observable, concat, from, interval, map, merge, mergeAll, of, take } from 'rxjs';
...
export class ConcatComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // ex-02 using map + merge all in this you dont have to subscribe again n again just used mergeall()

    const functioning1=['knowledge', 'fun', 'comedy','masti', 'tutorial']
